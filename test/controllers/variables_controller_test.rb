...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { date: @variable.date, month: @variable.month, payment_mode: @variable.payment_mode, year: @variable.year }
    end
  ...
  test "should update variable" do
    patch :update, id: @variable, variable: { date: @variable.date, month: @variable.month, payment_mode: @variable.payment_mode, year: @variable.year }
    assert_redirected_to variable_path(assigns(:variable))
  end
